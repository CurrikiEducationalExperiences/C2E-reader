...
const Myc2e = () => {
  ...
  return (
    <div className="reader-c2e">
      ...
      {!projects?.length ? (
        <>
          <h1 className="myC2E">My C2E's</h1>
          ...
          <div className="reader-main">
            {walletConnection ? (
              ...
              <div className="text-detail">
                ...
                <p>
                  … where access to high quality learning resources is
                  equitable, affordable, and widely available. <br />
                  <br /> … where digital content creators have access to
                  resources and incentives to build quality interactive learning
                  experiences, and marketplaces where they can get paid fairly
                  for their efforts.
                  <br /> <br /> … where the quality and appropriateness of
                  digital educational content can be vetted before it enters a
                  marketplace.
                </p>
              </div>
            )}
